/*
  ...
  1. Changes
    - Create function to initialize email settings for new users
    - Add trigger to automatically create settings on user creation
    - Set default email configuration values
